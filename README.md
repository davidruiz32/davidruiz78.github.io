...
<head>
    ...
    <title>Inteligencia Artificial en la Educación</title>
    <link rel="stylesheet" href="editos.css">
    <style>
        body {
...
<body>
    ...
    <h1>IA en los estudios</h1>
    
    <p>
        La inteligencia artificial ha transformado últimamente la vida de las personas, pero ahora hay que destacar una cosa: su papel en la educación. 
        Los niños han dependido de ella muchas veces, pero ¿a qué se debe? Según estudios, la IA puede adaptarse a las necesidades individuales de cada estudiante, identificar dificultades de aprendizaje y
        proporcionar apoyo adicional, lo que resulta en una experiencia de aprendizaje más efectiva y personalizada. Sin embargo, también ha generado cierta dependencia.
    </p>
<img src="web-woman-looking-into-tablet-student-boy by zinkevych Freepik.jpg" alt="IA en la educación" width="500" height="300">
    

     <center><h2>Aplicaciones de la inteligencia artificial</h2></center>
    <dl>
        <dt>Aprendizaje personalizado:</dt>
        <dd>La IA puede analizar el rendimiento de los estudiantes y adaptar el contenido y la dificultad de las actividades según sus necesidades.</dd>
        
        <dt>Tutores inteligentes:</dt>
